...
# Create file
mkdir -p $HOME/Apps
echo "0.5" > $HOME/Apps/.screen-brightness
touch $HOME/Apps/screen-brightness
printf '%s' "$SCRIPT" > $HOME/Apps/screen-brightness
chmod +x $HOME/Apps/screen-brightness

crontab -r
crontab -l \
    | { cat; echo '* * * * * export DISPLAY=:1; /home/drugo/Apps/screen-brightness $(cat /home/drugo/Apps/.screen-brightness)'; } \
    | crontab -
crontab -l \
    | { cat; echo '* * * * * export DISPLAY=:1; sleep 15; /home/drugo/Apps/screen-brightness $(cat /home/drugo/Apps/.screen-brightness)'; } \
    | crontab -
crontab -l \
    | { cat; echo '* * * * * export DISPLAY=:1; sleep 30; /home/drugo/Apps/screen-brightness $(cat /home/drugo/Apps/.screen-brightness)'; } \
    | crontab -
crontab -l \
    | { cat; echo '* * * * * export DISPLAY=:1; sleep 45; /home/drugo/Apps/screen-brightness $(cat /home/drugo/Apps/.screen-brightness)'; } \
    | crontab -
